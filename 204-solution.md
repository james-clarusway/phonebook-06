...
- Create a github-repo named `phonebook` and push the content.
...
git branch -M main
git remote add origin https://github.com/<GITHUB-USER-NAME>/phonebook.git
...
locals {
  github-repo     = "https://github.com/james-clarusway/phonebook.git"  # change the github-user name
}
